...
//  TheOldTimes
//
//  Created by Ashik Chowdhury on 5/5/19.
...
//    @IBOutlet weak var googleSigninButton: UIView!
    ...
    func handleRegister() {
        ...
        Auth.auth().createUser(withEmail: email, password: password) { (authResult, error) in
            ...
            self.ref = Database.database().reference(fromURL: "https://yourfolio-ebc31.firebaseio.com/")
    ...
    func setupGoogleSignInButton() {
        ...
        googleSigninButton.topAnchor.constraint(equalTo: loginRegisterButton.bottomAnchor, constant: 12).isActive = true
